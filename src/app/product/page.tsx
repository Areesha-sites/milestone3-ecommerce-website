    ...
    <div className="container bg-gradient-to-tl to-[#f1dac9] from-[#7f593e] p-3 mb-[-10rem] w-[100%] min-h-screen">
      <div className="container py-5 pb-[9rem]">
        <div className="flex justify-center items-center flex-col mt-[-1rem] ">
          <h1 className="py-4 md:text-5xl md:w-2/4 xl:text-[5.2vw] font-bold text-[#5a3e2b] xl:pl-[90px] xxs:text-[34px] xxs:leading-[38px] xxs:text-center">
            Step Into Our Flavor World
            <div className="xl:absolute xl:top-[10.3rem] xl:right-[17.5rem] mt-5 md:px-6 xxs:absolute xxs:top-[8.5rem] xxs:right-[1rem]">
              <Image
                src="/vector.png"
                alt="Coffee-Tag"
                title="Coffee-vector"
          ...
          <p className="py-2 text-[#5a3e2b] xl:text-[1rem] xl:text-center w-[70%] xxs:text-[13px] xxs:text-center">
