      ...
      <div className="bg-white border border-[#4b2f1d] rounded-lg m-[2rem] shadow-2xl flex w-full max-w-screen-xl h-[80vh] overflow-hidden bg-gradient-to-tl to-[#caa88c] from-[#7d4b26]  shadow-[#8f6c53]">
        ...
        <div className="relative w-1/2 h-full ">
          <Image
            ...
            height={300}
            width={300}
            className="rounded-l-lg xl:h-[60vh] xl:w-[40vw] mt-[5rem] hover:scale-105 hover:transition-all hover:ease-linear cursor-pointer duration-300 xl:ml-[3rem] xl:mt-[4rem]"
          />
        </div>
        ...
        <div className="p-6 w-1/2">
          ...
          <p className="mt-2 text-[#3c2110]">{hotBeverage.description}</p>
